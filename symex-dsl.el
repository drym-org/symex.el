...
procedure."
  (cond ((symbolp condition)
         (cond ((eq 'final condition)
                '(lambda (_result) (symex--point-at-final-symex-p)))
               ((eq 'initial condition)
                '(lambda (_result) (symex--point-at-initial-symex-p)))
               ((eq 'first condition)
                '(lambda (_result) (symex--point-at-first-symex-p)))
               ((eq 'last condition)
                '(lambda (_result) (symex--point-at-last-symex-p)))
               ((eq 'root condition)
                '(lambda (_result) (symex--point-at-root-symex-p)))
               (t condition)))
