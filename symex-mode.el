...
(defhydra hydra-symex (:idle 1.0
  ...
  ("C-S-j" symex-slurp-backward "slurp backward")
  ("C-(" symex-slurp-backward "slurp backward")
  ("C-S-h" symex-spit-backward "spit backward")
  ("C-{" symex-spit-backward "spit backward")
  ("C-S-l" symex-spit-forward "spit forward")
  ("C-}" symex-spit-forward "spit forward")
  ("C-S-k" symex-slurp-forward "slurp forward")
  ("C-)" symex-slurp-forward "slurp forward")
